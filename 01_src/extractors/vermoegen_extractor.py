"""
Concrete implementation of Excel extractor for Vermögensübersicht data.
"""
...
class VermoegenExtractor(BaseExcelExtractor):
    def extract_data(self, file_path: str | Path) -> pd.DataFrame:
        """
        Extract Vermögensübersicht data from Excel file.
        ...
        try:
            ...
            sheet_name = self._find_matching_sheet(xl, ["NB_Vermögensübersicht"])
